...
//            {
//                bool check = false;
//                string tensanpham = Request.Form["tensanpham1"];
//                string cpu = Request.Form["cpu1"];
//                string ram = Request.Form["ram1"];
//                string ocung = Request.Form["ocung1"];
//                string hedieuhanh = Request.Form["hedieuhanh1"];
//                string imgSp = Request.Form["imgSp1"];
//                string id = Request.Form["id1"];
//                string giaCu = Request.Form["giaCu1"];
//                string giaMoi = Request.Form["giaMoi1"];
...
//                    list.Add(new product(tensanpham, cpu, ram, ocung, hedieuhanh, imgSp, id,giaCu, giaMoi));
//                    Application["sanpham"] = list;
